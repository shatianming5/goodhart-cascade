#!/usr/bin/env bash
# GRPO training with test-passing-only reward
# verl uses CLI parameters, not YAML configs
...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/test_only_7b}"
N_GPUS="${N_GPUS:-4}"
...
python -m verl.trainer.main_ppo \
    ...
    --reward.reward_function "goodhart.rewards.test_passing" \
